...
import 'package:flutter_ngoctruong/firebase/dialogs.dart';
import 'package:flutter_ngoctruong/firebase/firebase_data.dart';
...
class _PageSVDetailState extends State<PageSVDetail> {
  ...
  void initState() {
    ...
    if(svs != null){
      ...
      txtQueQuan.text = svs!.sinhVien!.dia_chi??"";
      txtNamSinh.text = svs!.sinhVien!.ngay_sinh??"";
      if(xem! == true){
  ...
  _capNhat(BuildContext context) async {
    ...
    SinhVien sv = SinhVien(
      ...
      ten: txtTen.text,
      lop: txtLop.text,
      dia_chi: txtQueQuan.text,
      ngay_sinh: txtNamSinh.text,
      anh: null,
    );
